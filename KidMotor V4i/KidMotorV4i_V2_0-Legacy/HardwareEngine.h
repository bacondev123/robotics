...
#define M1A_PIN 2         // Left Motor IN1
#define M1B_PIN 3         // Left Motor IN2
#define M2A_PIN 6         // Right Motor IN1 (Moved off Pin 4)
#define M2B_PIN 7         // Right Motor IN2 (Moved off Pin 5)
